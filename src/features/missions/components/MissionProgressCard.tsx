...
export function MissionProgressCard({
  ...
  return (
    ...
    */
    <div className="rounded-[28px] bg-gray-50/80 p-5 border border-white/40 shadow-[6px_6px_16px_rgba(163,177,198,0.35),-6px_-6px_16px_rgba(255,255,255,1)] transition-all duration-300">
      ...
      {completed && (
        ...
        <div className="mt-4 rounded-2xl bg-emerald-50/50 border border-emerald-100/40 p-3 text-center text-xs font-bold text-emerald-600 shadow-[inset_2px_2px_5px_rgba(163,177,198,0.2),inset_-2px_-2px_5px_rgba(255,255,255,0.7)] tracking-wide uppercase">
          Mission Completed
        </div>
      )}
